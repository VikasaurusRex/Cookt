...
//        Order order = Order.fromSnapshot(snapshots.documents.elementAt(i));
...
//  }
//
//  Widget _orderOptions(BuildContext context, Order order){
//    return Row(
...
//    for(Order order in requestedOrders){
//      currentOrders.insert(0, _orderCell(order));
//    }
//    for(Order order in acceptedOrders){
//      currentOrders.add(_orderCell(order));
//    }
//    setState(() {});
//  }
//
//  Future<void> _presentDialog(bool isCancelling, Order order) async {
